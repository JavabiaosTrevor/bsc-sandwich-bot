...
# BSC/EVM MEV BNB Sandwich Bot for Pancakeswap

A Sandwich Bot for BSC (BNB), ETH, AVAX, MATIC, FTM, CRO, Harmony, Milkomeda, Moonforce, etc. Default for Pancakeswap. Use at your own risk. Designed to monitor EVM mempools and seek potentially profitable transactions to sandwich.
...
- ⚡ Lightning-fast mempool monitoring
- 🥪 Improved sandwiching functionality
...
A: I managed to make 0.5 BNB in 1 day with this sandwich bot, however your results maybe different. You may make more or less than when I first tested this tool.
